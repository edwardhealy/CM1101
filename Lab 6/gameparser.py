...
def normalise_input(user_input):
    ...
    no_punct = remove_punct(user_input).lower() #this function is instructed to remove punctuation from the user's input and convert all the letters to lower case
    no_punct=no_punct.split() #this is programming the function to split the user input up so the user input could be chekced word 
    #for word and the no_punct function could be executed
    return filter_words(no_punct, skip_words) # output of the function
